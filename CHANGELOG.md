...
## [0.17.1](https://github.com/loonghao/shotgrid-mcp-server/compare/v0.17.0...v0.17.1) (2026-09-23)


### Bug Fixes

* **skills:** deliver non-UTF-8 text files as blobs and accept frontmatter at EOF ([#166](https://github.com/loonghao/shotgrid-mcp-server/issues/166)) ([8268493](https://github.com/loonghao/shotgrid-mcp-server/commit/82684931de6350c46e69aab5350fff74b8c535c3))

## Legacy changelog (commitizen, before release-please)

The entries below were generated by commitizen and are kept verbatim for
history. release-please writes every new entry above this section.
